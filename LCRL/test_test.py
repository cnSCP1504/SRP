...
from src.lcrl.automata.ldba import LDBA
from src.lcrl.core.lcrl_core import LCRL
from src.lcrl.animator.animator import animate
...
def train(
    ...
    if algorithm == 'ql':
        ...
        import dill
        from src.lcrl.environments.MarsRoverDA import MarsRover
    elif algorithm == 'nfq':
        ...
        from src.lcrl.environments.MarsRoverCA import MarsRover
    else:
