...
import random
import numpy as np
from lcrl.src.environments.SlipperyGrid import SlipperyGrid
from lcrl.src.automata.ldba import LDBA
from lcrl.src.core.lcrl_core import LCRL
from lcrl.src.animator.animator import animate
...
def train(
    ...
    if algorithm == 'ql':
        ...
        import dill
        from lcrl.src.environments.MarsRoverDA import MarsRover
    elif algorithm == 'nfq':
        ...
        from lcrl.src.environments.MarsRoverCA import MarsRover
    else:
    ...
    if isinstance(MDP, SlipperyGrid) and test and learning_task.successes_in_test / number_of_tests > 0.8:
